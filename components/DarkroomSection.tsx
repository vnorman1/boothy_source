              ...
              {FILTER_OPTIONS.map(filter => (
                ...
                >
                  <img 
                    ...
                    alt={filter.name} 
                    className={`w-full aspect-square object-cover rounded-lg ring-2 transition ${filter.className} ${selectedFilter === filter.id ? 'ring-amber-600' : 'ring-transparent group-hover:ring-amber-600/50'}`} 
                  />
